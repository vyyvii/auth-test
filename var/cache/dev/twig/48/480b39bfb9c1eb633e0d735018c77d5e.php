...
class __TwigTemplate_36cdc6ac9e4dc9fb159c4be98aa4f6bd extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <h1 class=\"mb-3 font-weight-normal\">Accueil</h1>
    ...
    ";
        ...
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 8, $this->source); })()), "user", [], "any", false, false, false, 8)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 9
            yield "        <p>Vous êtes connecté en tant que ";
        ...
        <button onclick=\"window.location.href=\x27";
            // line 11
    ...
    ";
            ...
            // line 15
            yield "        <div class=\"center-element\">
            <button onclick=\"window.location.href=\x27";
            // line 16
    ...
    {
        return array (  129 => 20,  122 => 16,  119 => 15,  112 => 11,  106 => 9,  104 => 8,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    <h1 class=\"mb-3 font-weight-normal\">Accueil</h1>

    {% if app.user %}
        <p>Vous êtes connecté en tant que {{ app.user.email }}</p>

        <button onclick=\"window.location.href=\x27{{ path(\x27app_logout\x27) }}\x27\">
            Déconnexion
        </button>
    {% else %}
        <div class=\"center-element\">
            <button onclick=\"window.location.href=\x27{{ path(\x27app_login\x27) }}\x27\">
                Connexion
            </button>

            <button onclick=\"window.location.href=\x27{{ path(\x27app_register\x27) }}\x27\">
                Inscription
            </button>
        </div>
    {% endif %}
